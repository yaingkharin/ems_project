...
class CreateTicketRequest(serializers.Serializer):
    ...
    ticket_type = serializers.ChoiceField(choices=['VIP', 'Standard', 'Regular', 'Student'])
...
class UpdateTicketRequest(serializers.Serializer):
    ...
    ticket_type = serializers.ChoiceField(choices=['VIP', 'Standard', 'Regular', 'Student'], required=False)
