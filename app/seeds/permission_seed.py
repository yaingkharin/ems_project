...
def seed_permissions():
    permissions_data = [
        ...
        {'name': 'all_images', 'display_name': 'All Images', 'group': 'Images', 'sort': 1},
        {'name': 'view_images', 'display_name': 'View Images', 'group': 'Images', 'sort': 2},
        {'name': 'create_images', 'display_name': 'Create Images', 'group': 'Images', 'sort': 3},
        {'name': 'edit_images', 'display_name': 'Edit Images', 'group': 'Images', 'sort': 4},
        {'name': 'delete_images', 'display_name': 'Delete Images', 'group': 'Images', 'sort': 5},

        # Customer Management Permissions
        {'name': 'all_customers', 'display_name': 'All Customers', 'group': 'Customers', 'sort': 1},
        {'name': 'view_customers', 'display_name': 'View Customers', 'group': 'Customers', 'sort': 2},
        {'name': 'create_customers', 'display_name': 'Create Customers', 'group': 'Customers', 'sort': 3},
        {'name': 'edit_customers', 'display_name': 'Edit Customers', 'group': 'Customers', 'sort': 4},
        {'name': 'delete_customers', 'display_name': 'Delete Customers', 'group': 'Customers', 'sort': 5},

        # Authentication Management Permissions
        {'name': 'all_authentications', 'display_name': 'All Authentications', 'group': 'Authentications', 'sort': 1},
        {'name': 'view_authentications', 'display_name': 'View Authentications', 'group': 'Authentications', 'sort': 2},
        {'name': 'create_authentications', 'display_name': 'Create Authentications', 'group': 'Authentications', 'sort': 3},
        {'name': 'edit_authentications', 'display_name': 'Edit Authentications', 'group': 'Authentications', 'sort': 4},
        {'name': 'delete_authentications', 'display_name': 'Delete Authentications', 'group': 'Authentications', 'sort': 5},
