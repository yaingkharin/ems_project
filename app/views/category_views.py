...
from app.dto.requests.category_request import CreateCategoryRequest
...
class CategoryListCreateView(APIView):
    ...
    def get(self, request):
        ...
        return api_response(data=all_categories, message="Categories retrieved successfully.")
    ...
    def post(self, request):
        ...
        try:
            category_response_dto = CategoryService.create_category(validated_data)

            return api_response(
                data=category_response_dto,
...
class CategoryRetrieveUpdateDestroyView(APIView):
    ...
    def get(self, request, pk):
        ...
        if category_by_id:
            return api_response(data=category_by_id, message="Category retrieved successfully.")
    ...
    def put(self, request, pk):
        ...
        category_response_dto = CategoryService.update_category(pk, validated_data)
        if category_response_dto:
            return api_response(data=category_response_dto, message="Category updated successfully.")
        return api_response(message="Category not found.", success=False, status_code=status.HTTP_404_NOT_FOUND)
